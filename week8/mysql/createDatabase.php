...
if (mysql_query("CREATE DATABASE `homework8` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci",$con))
  ...
  echo "Error creating database: " . mysql_error();
	...
	// $sqlnew7= "insert into new1 (newstitle, newsimg, newsfrom, addtime) values ('请在这里修改新闻标题newsid6','','修改修改','修改')";
	// $sqlnew8= "insert into new1 (newstitle, newsimg, newsfrom, addtime) values ('请在这里修改新闻标题newsid6','','修改修改','修改')";
	mysql_query($sqlnew1);
	mysql_query($sqlnew2);
	mysql_query($sqlnew3);
	mysql_query($sqlnew4);
