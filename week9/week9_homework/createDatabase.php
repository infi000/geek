...
if (mysql_query("CREATE DATABASE `homework9` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci",$con))
  ...
  echo "Error creating database: " . mysql_error();
	...
	$sqlnew5= "insert into new1 (tag, newstitle, newsimg, newsfrom, addtime) values ('1','请在这里修改新闻标题newsid5','','修改修改','修改')";
	$sqlnew6= "insert into new1 (tag, newstitle, newsimg, newsfrom, addtime) values ('1','请在这里修改新闻标题newsid6','','修改修改','修改')";	
	// 创建百家页面的新闻表
